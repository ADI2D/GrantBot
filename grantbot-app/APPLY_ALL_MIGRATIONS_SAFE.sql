-- ============================================================================
-- APPLY ALL RECENT MIGRATIONS (SAFE VERSION)
-- Run this in your Supabase SQL Editor to enable all new features
-- This version includes transaction handling to prevent deadlocks
-- ============================================================================

-- Start transaction with explicit lock timeout
BEGIN;
...
-- ============================================================================
-- PART 2: Opportunities table updates (separate transaction)
...
-- ============================================================================
-- PART 3: Opportunities RLS policies (separate transaction)
...
FROM opportunities
WHERE application_url LIKE '%grants.gov/search-results-detail%';
-- Should return the number of Grants.gov opportunities
...
-- - Fixed Grants.gov URLs that work correctly
-- ============================================================================
