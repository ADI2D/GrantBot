...
/**
 * POST /api/opportunities/analyze-url
 *
 * Analyzes grant opportunity URL(s) using AI to extract details and calculate alignment.
 * Accepts an array of URLs in the request body and processes them together.
 *
 * Request body:
 * {
...
export async function POST(request: NextRequest) {
  try {
    ...
    // 3. Calculate alignment score based on organization profile
    // 4. Extract compliance requirements
    // 5. Store in database

    // For now, return a mock response
    const mockOpportunity = {
      name: "Custom Grant Opportunity",
